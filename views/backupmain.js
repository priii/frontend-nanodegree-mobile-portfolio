...
var resizePizzas = function(size) {
  window.performance.mark("mark_start_resize");   // User Timing API function
    var pizzaSize = document.getElementById("pizzaSize"); // instead of querySelector everytime using getElementById and storing it in a var.

    // combined sliderLabel and sizeSwitcher
  // Changes the value for the size of the pizza above the slider

  function changeSliderLabel(size) {
    switch(size) {
      case "1":
        pizzaSize.innerHTML = "Small"; // using the above defined var pizzaSize instead of   document.querySelector("#pizzaSize")
        return;
      case "2":
 ...
 // Iterates through pizza elements on the page and changes their widths
  function changePizzaSizes(size) {
    var randomPizzaContainer = document.getElementByClass('randomPizzaContainer'); // replaced the querySelector and stored in a var
    // calculations are moved outside the loop
...
function updatePositions() {
  ...
  var items = document.getElementsByClassName('mover'); // replaced by getElementsByClassName for the dom speed.
  var phase = Math.sin((document.body.scrollTop / 1250) + (i % 5));// moved the calculation from the for-loop
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var movingPizzas1 = document.getElementById("movingPizzas1"); // replaced the querySelector
  for (var i = 0; i < 200; i++) {
